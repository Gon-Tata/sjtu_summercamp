...
#ifndef ORIGINBOT_MSGS__SRV__DETAIL__ORIGINBOT_LED__FUNCTIONS_H_
#define ORIGINBOT_MSGS__SRV__DETAIL__ORIGINBOT_LED__FUNCTIONS_H_
...
/// Initialize srv/OriginbotLed message.
/**
...
/// Finalize srv/OriginbotLed message.
/**
...
/// Create srv/OriginbotLed message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * originbot_msgs__srv__OriginbotLed_Request__init().
...
/// Destroy srv/OriginbotLed message.
/**
 * It calls
 * originbot_msgs__srv__OriginbotLed_Request__fini()
...
/// Check for srv/OriginbotLed message equality.
/**
...
/// Copy a srv/OriginbotLed message.
/**
...
/// Initialize array of srv/OriginbotLed messages.
/**
...
/// Finalize array of srv/OriginbotLed messages.
/**
 * It calls
 * originbot_msgs__srv__OriginbotLed_Request__fini()
...
/// Create array of srv/OriginbotLed messages.
/**
 * It allocates the memory for the array and calls
 * originbot_msgs__srv__OriginbotLed_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OriginbotLed messages.
/**
 * It calls
 * originbot_msgs__srv__OriginbotLed_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OriginbotLed message array equality.
/**
...
/// Copy an array of srv/OriginbotLed messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * originbot_msgs__srv__OriginbotLed_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_originbot_msgs
...
/**
 * It calls
 * originbot_msgs__srv__OriginbotLed_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_originbot_msgs
...
/**
 * It allocates the memory for the array and calls
 * originbot_msgs__srv__OriginbotLed_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_originbot_msgs
...
/**
 * It calls
 * originbot_msgs__srv__OriginbotLed_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ORIGINBOT_MSGS__SRV__DETAIL__ORIGINBOT_LED__FUNCTIONS_H_
