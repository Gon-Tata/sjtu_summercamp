  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = originbot_msgs__srv__OriginbotPID_Request;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
static size_t _OriginbotPID_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_originbot_msgs__srv__OriginbotPID_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = originbot_msgs__srv__OriginbotPID_Response;
    is_plain =
      (
...
static size_t _OriginbotPID_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_originbot_msgs__srv__OriginbotPID_Response(
    full_bounded, is_plain, 0);
