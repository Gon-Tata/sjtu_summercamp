  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = originbot_msgs__srv__OriginbotBuzzer_Request;
    is_plain =
      (
...
static size_t _OriginbotBuzzer_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_originbot_msgs__srv__OriginbotBuzzer_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = originbot_msgs__srv__OriginbotBuzzer_Response;
    is_plain =
      (
...
static size_t _OriginbotBuzzer_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_originbot_msgs__srv__OriginbotBuzzer_Response(
    full_bounded, is_plain, 0);
