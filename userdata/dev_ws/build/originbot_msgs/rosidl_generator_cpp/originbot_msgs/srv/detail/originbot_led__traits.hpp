...
inline void to_flow_style_yaml(
  const OriginbotLed_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: on
...
inline std::string to_yaml(const OriginbotLed_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const originbot_msgs::srv::OriginbotLed_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const originbot_msgs::srv::OriginbotLed_Request & msg)
{
...
inline void to_flow_style_yaml(
  const OriginbotLed_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: result
...
inline std::string to_yaml(const OriginbotLed_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use originbot_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const originbot_msgs::srv::OriginbotLed_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  originbot_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use originbot_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const originbot_msgs::srv::OriginbotLed_Response & msg)
{
  return originbot_msgs::srv::to_yaml(msg);
}
